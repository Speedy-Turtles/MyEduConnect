...
<template>
  <div id="test" class="row text-center">
        <div class="col-lg-4">
         <v-card class="elevation-12" :disabled="Waiting==''">
           <v-toolbar dark color="yellow">
              <v-toolbar-title >Wating</v-toolbar-title>
           </v-toolbar>
             <draggable  :group="{ name: 'app', put: true }" :options="dragOptions" v-model="Waiting" 
             @change="onUserMove"  
             @add="checkMove('waiting')"
             >
                 <v-card  v-for="user in Waiting" :key="user.id"
       ...
       >
        ...
        <div class="col-lg-4">
         <v-card class="elevation-12">
           ...
           >
           <div v-if="Accpted==''">
             <img src="../../assets/interdit.jpg" id="interdit" width="70px">
             <div class="novote">
                 No User Here
             </div>
            </div>
